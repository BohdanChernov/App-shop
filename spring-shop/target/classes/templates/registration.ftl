...
<main role="main" class="container-fluid">
    <div class="row mt-1 post justify-content-center">
        <div class="col-lg-4">
            <form method="post">
                ...
                <input name="email" type="email" class="form-control mb-2" id="inlineFormInput"
                       placeholder="E-mail">
                <input name="name" type="" class="form-control mb-2" id="inlineFormInput"
                       placeholder="Имя">
                <input name="lastName" type="text" class="form-control mb-2" id="inlineFormInput"
                       placeholder="Фамилия">
                <input name="tel" type="tel" class="form-control mb-2" id="inlineFormInput"
                       placeholder="Телефон">
                <input name="password" type="password" class="form-control mb-2" id="inlineFormInput"
                       placeholder="Пароль">
                <input name="repassword" type="password" class="form-control mb-2" id="inlineFormInput"
                       placeholder="Потдверждение пароля">

                <button type="submit" class="btn btn-outline-secondary mb-2">Зарегистрироваться</button>
