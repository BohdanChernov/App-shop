...
<main role="main" class="container">
    <div class="row justify-content-center">
        Доставка в отделения «Нова пошта» по всей Украине<br>
        ...
        Обращаем Ваше внимание на то, что стоимость доставки одной единицы товара может варьироваться в зависимости от
        веса и габаритов (от 50грн до 4000грн.), точная стоимость доставки расчитана на карточке товара.
        Подъем габаритных грузов от 30 до 100 кг оплачивается отдельно. Стоимость подъема: 30–200 грн/этаж в зависимости
        от веса и габаритов товара, а так же сложности подъема.
        О прибытии заказа в отделение вы будете уведомлены SMS-сообщением «Новая Почта» с указанием номера накладной
        Ваш заказ будет бесплатно храниться в отделении в течение 3 рабочих дней. Если по истечении данного срока вы не
        получите заказ, товар вернется продавцу.
        Адресная доставка «Нова Пошта», при условии оплаты заказа наличными, на сумму более 50 000 грн не
        осуществляется.
